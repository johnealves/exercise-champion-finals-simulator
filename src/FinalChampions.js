...
const mapStateToProps = ({ GolsReducer }) => ({
  maschesterCityGols: GolsReducer.maschesterCityGols,
  PSGGols: GolsReducer.PSGGols,
  realMadridGols: GolsReducer.realMadridGols,
  chelseaGols: GolsReducer.chelseaGols,
})
